...
--Create a SQL query that finds all Department name
	SELECT [Name] FROM Departments

--03.Find Salary of Each Employee
--Create a SQL query that finds the first name, last name and salary for each employe
	SELECT FirstName, LastName, Salary FROM Employees

--04.Find Full Name of Each Employee
--Create a SQL query that finds the first, middle and last name for each employe
